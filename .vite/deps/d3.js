        ...
        if (!transition) {
          ...
          d3.timer(function(elapsed) {
            ...
            function start(elapsed2) {
              ...
              duration = transition.duration;
              d3.timer(function() {
                timer.c = tick(elapsed2 || 1) ? d3_true : tick;
                return 1;
              }, 0, time);
            }
            function tick(elapsed2) {
              if (lock.active !== id) return 1;
              var t = elapsed2 / duration, e = ease(t), n = tweened.length;
              while (n > 0) {
